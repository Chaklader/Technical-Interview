...
print('BST2', bst2);
print('BREADTHFIRST LTR', bst2.breadthFirstLTR());
print('BREADTHFIRST RTL', bst2.breadthFirstRTL());
print('PREORDER', bst2.preOrder());
print('INORDER', bst2.inOrder());
print('POSTORDER', bst2.postOrder());
...
print(bst3);
print('BREADTHFIRST LTR', bst3.breadthFirstLTR());
print('BREADTHFIRST RTL', bst3.breadthFirstRTL());
print('PREORDER', bst3.preOrder());
print('INORDER', bst3.inOrder());
print('POSTORDER', bst3.postOrder());
...
print(bst2.findMin()); // 3
print(bst2.findMax()); // 30
print(bst2.contains(15));
...
print(bst2);
print(bst2.getDepth()); // 3
print(bst2.add(7).add(50).add(80).add(98));
print(bst2.getDepth()); // 5
print(bst2.nodeAverages()); //[ 10, 12.5, 13.67, 22, 80, 98 ]

print(bst2.convertToLinkedList());
