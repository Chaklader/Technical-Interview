...
# <h1 id="yui_3_18_1_1_1464168312477_3103">1630 Amalfi Dr, <span class="zsg-h2 addr_city">Pacific Palisades, CA 90272</span> </h1>
def get_video_page_urls():
    ...
    # a.attrs.get('href') for a in soup.select('div.zsg-photo-card-caption a[href^=/homedetails]')
    # <div class="zsg-photo-card-caption"><h4 class="zsg-photo-card-spec"><span class="zsg-photo-card-status"><span class="zsg-icon-for-sale"></span>Foreclosure</span></h4><p class="zsg-photo-card-spec"><span class="zsg-photo-card-price">$59,900</span><span class="zsg-photo-card-info">2 bds <span class="interpunct">·</span> 1 ba <span class="interpunct">·</span> 992 sqft</span></p><p class="zsg-photo-card-spec"><span class="zsg-photo-card-notification ">8 days on Zillow</span><span class="interpunct">·</span><span class="zsg-photo-card-address">36931 Old Ocean City Rd, Willards, MD</span></p></div>
